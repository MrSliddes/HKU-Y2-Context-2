...
namespace SLIDDES.LevelEditor.SideScroller3D
{
    ...
    public class SideScroller3D : EditorWindow
    {
        ...
        [MenuItem("Window/SLIDDES/Level Editor/Side Scroller 3D/Settings")]
        public static void ShowWindow()
        {
            //Show existing window instance. If one doesn't exist, make one.
            EditorWindow window = EditorWindow.GetWindow(typeof(SideScroller3D), false, "SS3D Settings"); // Name
            window.minSize = new Vector2(100, 140);
            windowToolbar_0 = EditorWindow.GetWindow(typeof(Toolbar_0), false, "Lvl Editor Toolbar 0");
