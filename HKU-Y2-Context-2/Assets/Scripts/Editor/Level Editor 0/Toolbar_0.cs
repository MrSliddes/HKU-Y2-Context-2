...
namespace SLIDDES.LevelEditor.SideScroller3D
{
    ...
    public class Toolbar_0 : EditorWindow
    {
        ...
        public static void ShowWindow()
        {
            ...
            EditorWindow window = EditorWindow.GetWindow(typeof(SideScroller3D), false, "Toolbar 0"); // Name
        ...
        public void OnGUI()
        {
            ...
            if(SideScroller3D.toolbar_0_fileDirectory != null) // Prevent wierd bug
            {
                string[] folderContent = AssetDatabase.FindAssets("t:GameObject", new[] { SideScroller3D.toolbar_0_fileDirectory });
